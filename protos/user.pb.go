...
func (x *AuthenticateUserReq) Reset() {
	*x = AuthenticateUserReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthenticateUserReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthenticateUserReq) ProtoMessage() {}

func (x *AuthenticateUserReq) ProtoReflect() protoreflect.Message {
	mi := &file_protos_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthenticateUserReq.ProtoReflect.Descriptor instead.
func (*AuthenticateUserReq) Descriptor() ([]byte, []int) {
	return file_protos_user_proto_rawDescGZIP(), []int{4}
}

func (x *AuthenticateUserReq) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
var file_protos_user_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x37, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x22, 0x6e, 0x0a, 0x14, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63,
	...
	,
...
var file_protos_user_proto_goTypes = []interface{}{
	...
	(*AuthenticateUserReq)(nil),  // 4: AuthenticateUserReq
	(*Empty)(nil),                // 5: Empty
	(*AuthenticateUserResp)(nil), // 6: AuthenticateUserResp
}
var file_protos_user_proto_depIdxs = []int32{
	...
	5, // 2: UserService.Authenticate:input_type -> Empty
	1, // 3: UserService.Register:output_type -> UserRegResp
	3, // 4: UserService.Login:output_type -> UserLoginResp
	6, // 5: UserService.Authenticate:output_type -> AuthenticateUserResp
...
func file_protos_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthenticateUserReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
